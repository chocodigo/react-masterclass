...
const BackButton = styled.div`
  ...
  font-weight: bold;
  font-size: large;
  box-shadow: 0.01px 0.01px 0.1em ${(props) => props.theme.textColor};
...
const HeaderCompDiv = styled.div`
  display: block;
  width: 33%;
`;
        ...
        <>
          ...
          <Switch>
            <Route path={`/:coinId/price`}>
              <Price priceData={priceInfo?.quotes.USD}/>
            </Route>
